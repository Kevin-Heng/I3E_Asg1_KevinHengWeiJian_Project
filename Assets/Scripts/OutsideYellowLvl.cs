...
public class OutsideYellowLvl : MonoBehaviour
{
    ...
    {
        interactText.text = "Push the blue box with a blue power up";
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        {
            other.gameObject.GetComponent<Player>().OutsideYellowLvl(this); //reference the object
    ...
    private void OnTriggerExit(Collider other)
    {
        if (other.gameObject.tag == "Player")
        {
            other.gameObject.GetComponent<Player>().OutsideYellowLvl(null); //removes reference from object
