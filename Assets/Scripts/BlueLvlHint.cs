...
public class BlueLvlHint : MonoBehaviour
{
    ...
    {
        interactText.text = "Push the red box into the red hole";
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        {
            other.gameObject.GetComponent<Player>().OpenBlueHint(this); //reference the object
    ...
    private void OnTriggerExit(Collider other)
    {
        if (other.gameObject.tag == "Player")
        {
            other.gameObject.GetComponent<Player>().OpenBlueHint(null); //removes reference from object
