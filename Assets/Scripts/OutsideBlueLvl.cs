...
public class OutsideBlueLvl : MonoBehaviour
{
    ...
    {
        interactText.text = "Push the red box with a red power up";
    ...
    private void OnTriggerEnter(Collider other)
    {
        ...
        {
            other.gameObject.GetComponent<Player>().OutsideBlueLvl(this); //reference the object
    ...
    private void OnTriggerExit(Collider other)
    {
        if (other.gameObject.tag == "Player")
        {
            other.gameObject.GetComponent<Player>().OutsideBlueLvl(null); //removes reference from object
